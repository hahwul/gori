...
- Network: outbound requests honor `HTTPS_PROXY`, `HTTP_PROXY`, `ALL_PROXY`, and `NO_PROXY` when no explicit gori upstream is configured; TLS-proxy warnings and WebSocket no-response diagnostics now follow that environment route too (#1114)
