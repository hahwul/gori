...
- Projects: export and import compact, WAL-safe `.gori` snapshots from the CLI and picker, with a fresh id on import and a sensitive-data summary; archives keep stored data unredacted (#1230)
