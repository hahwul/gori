# Probe active dedup_key vs plan micro-benchmark. The analyzer now checks rule.dedup_key BEFORE
...
#
# Build: crystal build bench/probe_active_bench.cr -o bin/probe_active_bench --release
# Run:   bin/probe_active_bench
require "benchmark"
