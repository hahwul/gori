...
module Gori::Tui
  ...
  class ComparerController < TabController
    ...
    def body_hint(focus : Symbol) : String
      ...
      keys("←/→ req|res · ↑/↓ row · {comparer.next-change}/{comparer.prev-change} change · space → z fold · {comparer.copy} copy · ⇧←/→ h-scroll · {comparer.pick-a}/{comparer.pick-b} pick · {comparer.swap} swap · space cmds")
    end
  end
end
