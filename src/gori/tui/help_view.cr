...
module Gori::Tui
  ...
  class HelpView
    ...
    SECTIONS = [
      ...
      {"OTHER TABS", [
        Item.new("Sitemap", "↑/↓ · {sitemap.query} filter · ↵/→ expand · {sitemap.mark-toggle} mark · {sitemap.mark-all} all · {sitemap.toggle-grouping} fold · {scope.toggle-lens} scope · space → m tag · space → J scan JS"),
