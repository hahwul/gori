module Gori::Tui
  ...
  class Jobs
    ...
    KIND_LABELS = {:miner => "mining", :scan => "scanning", :fuzz => "fuzzing", :discover => "discovering", :minimize => "minimizing", :sequence => "sequencing", :oast => "listening", :authorize => "authorizing", :fuzz_save => "saving results", :fuzz_load => "loading results", :import => "importing", :retest => "retesting"}
