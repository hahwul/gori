  ...
  module Verbs
    ...
    def self.register_fuzz(r : Verb::Registry) : Nil
      ...
      r.register Verb::Definition.new(
        ...
        available: in_fuzzer, mnemonic: 'r') { |ctx| ctx.fuzz_run; nil }
      r.register Verb::Definition.new(
        "fuzz.stop", "Stop fuzz", "Stop the running fuzz", Verb::Scope::Fuzzer,
        available: in_fuzzer, mnemonic: 's') { |ctx| ctx.fuzz_stop; nil }
      r.register Verb::Definition.new(
      ...
      r.register Verb::Definition.new(
        ...
        available: in_fuzzer, mnemonic: 'm') { |ctx| ctx.fuzz_automark; nil }
    end
